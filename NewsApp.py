...
top_pos_words = [feature_names[i] for i in coefficients.argsort()[-10:][::-1]]
top_neg_words = [feature_names[i] for i in coefficients.argsort()[:10]]

st.markdown("### 🧠 What the model has learned")
st.caption("These are the words that most strongly drive predictions")
